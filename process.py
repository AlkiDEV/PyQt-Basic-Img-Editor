...
# Form implementation generated from reading ui file '.\kotely.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("E:\\RutekPoligon\\Aplikacje Desktopowe (Pracownia)\\Qt\\Projekt8_1\\img/208827851-760x535-1.jpg"))
        ...
        self.verticalSlider_3.valueChanged['int'].connect(self.saturation_value) # type: ignore
    ...
    def change_saturation(self, img, value):
        # img = cv2.imread(img)
        hsv = cv2.cvtColor(img, cv2.COLOR_BGR2HSV)
        hsv[..., 1] = hsv[..., 1] * (value / 100.0)
        new_img = cv2.cvtColor(hsv, cv2.COLOR_HSV2BGR)
        # new_qimg = QImage(new_img.data, new_img.shape[1], new_img.shape[0], QImage.Format_RGB888)
    ...
    def update(self):
        ...
        img = self.change_saturation(img, self.sat_value_now)
        self.setPhoto(img)
